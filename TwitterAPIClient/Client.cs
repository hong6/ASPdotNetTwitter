...
namespace TwitterApiClient
{
    ...
    public class Client
    {
        ...
        //public string GetUserTimelineJson(string bearerToken, string screenName, int count = 5, bool excludeReplies = false, bool includeRTs = true)        
        public string GetUserTimelineJson(string bearerToken, string parameters)        
        {            
            var webrequest = CreateRequest("/1.1/statuses/user_timeline.json" + parameters);
        ...
        private static WebRequest CreateRequest(string url)
        {
            ...
            //((HttpWebRequest)webrequest).UserAgent = "vogue.co.uk";
            return webrequest;
        }
